...
module.exports = async (req, res) => {
	...
	const url = `http://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getNearbyMsrstnList?serviceKey=${serviceKey}&returnType=json&tmX=${encodeURIComponent(tmX)}&tmY=${encodeURIComponent(tmY)}`;
