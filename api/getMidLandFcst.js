...
module.exports = async (req, res) => {
	...
	const url = `http://apis.data.go.kr/1360000/MidFcstInfoService/getMidLandFcst?serviceKey=${serviceKey}&dataType=JSON&pageNo=1&numOfRows=10${regId ? `&regId=${encodeURIComponent(regId)}` : ""}${tmFc ? `&tmFc=${encodeURIComponent(tmFc)}` : ""}`;
