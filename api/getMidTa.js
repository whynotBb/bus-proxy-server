...
module.exports = async (req, res) => {
	...
	const url = `http://apis.data.go.kr/1360000/MidFcstInfoService/getMidTa?serviceKey=${serviceKey}&dataType=JSON&pageNo=1&numOfRows=1000${regId ? `&nx=${encodeURIComponent(regId)}` : ""}${tmFc ? `&ny=${encodeURIComponent(tmFc)}` : ""}`;
